...
![](~/work/NPZD-NC/NPZD/Input data/NPZD.jpg)
...
![](~/work/NPZD-NC/NPZD/Input data/map BPNS.png)
...
For the Gulf of Trieste, Sea Temperature and Salinity along with Nutrients, Chlorophyll-a data and Phytoplankton abundances were collected from the C1 station. This station is a coastal marine observatory site lying within the Marine Protected Area (MPA) of Miramare (Gulf of Trieste - northernmost part of the Adriatic Sea) for the monthly in-situ monitoring of seawater physical, biogeochemical and biological properties (discrete sampling depths 0m, 5m, 10m and 15m). Since October 2005, the station has been managed by the Oceanography Section of the OGS and it was formally included in the Italian network of long-term ecological research sites (LTER-Italy) in 2006. Atmospheric and seawater carbon data were instead collected from the IT-FOS-PALOMA station. This station, run by the CNR-ISMAR (National Research Council of Italy - Marine Sciences Institute) and formally included in the ICOS network, is a fixed coastal buoy located in the centre of the Gulf of Trieste (about 8 nm from the C1-LTER station) that makes continuous and discrete measurements of the carbonate chemistry and complementary variables and is fully representative of the air-sea exchanges of CO2 and related acidification characterizing this part of the Mediterranean Sea.

![](~/work/NPZD-NC/NPZD/Input data/Intro_C1_Vlab3_Blue-Cloud_2026_MAP.png)
*Figure 3*. Location of the stations of interest (C1-LTER) and IT-FOS-PALOMA in the Gulf of Trieste (northern Adriatic Sea).
