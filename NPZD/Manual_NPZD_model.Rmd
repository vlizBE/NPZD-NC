...
If you already have balanced the model, you can skip to section 3.3 after providing the 'needed' information below. If you are running the model for the first time, calibrating the model to your environmental settings is required and you start at section 3.1.
